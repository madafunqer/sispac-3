                            ...
                            <table class="table table-bordered table-condensed table-responsive table-striped dataTable no-footer" id="models" role="grid" aria-describedby="models_info" cellpadding="5px;">
                                <thead class="thead-dark">
                                    <tr role="row">
                                        ...
                                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%;">Nama Aset</th>
                                        ...
                                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%;">Susut Nilai Semasa [RM]</th>
                                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%;">Nilai Buku Bersih [RM]</th>
                                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%;">Ada Komponen</th>
