        ...
        <div class="card-body">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Aduan Kerosakan Aset</h3>
                </div>
                <div class="panel-body" id="panel">   
                    <form id="findDaftarRosakListLink2" name="findDaftarRosakListLink2" action="/ePBT_SSHT/penggunaan/findDaftarRosakListLink2" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input type="text" name="aduank.indukNhrta" value="" disabled="disabled" id="indukNhrta" class="form-control input-sm">
                            ...
                            <div class="input-group">      
                                <input type="hidden" name="aduank.aduNosiri" value="" id="aduNosiri" class="form-control input-sm">
                            </div>  
                        </div> 
                        <div class="row">                      
                        ...
                        <div class="col-sm-12">
                            <table class="table table-bordered table-condensed table-responsive table-striped dataTable no-footer" id="models" role="grid" aria-describedby="models_info" cellpadding="5px;">
                                <thead class="thead-dark">
                                    <tr role="row">
                                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%">No. Aset</th>
                                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 40%">Perihal Kerosakan</th>
                                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%">Tarikh Aduan</th>
                                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%">Tarikh Kerosakan</th>
