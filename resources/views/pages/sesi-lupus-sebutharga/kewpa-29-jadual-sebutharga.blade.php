            ...
            <div class="card-body">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">Sesi Pelupusan (Sebutharga) &gt; [KEW.PA 29] Jadual Sebutharga</h3>
                    </div>
                    <div class="panel-body" id="panel">
                        <form id="findSenaraiKewpa26ListLink2" name="findSenaraiKewpa26ListLink2" action="/ePBT_SSHT/pelupusan/findSenaraiKewpa26ListLink2" method="post" class="form-horizontal">
                            <div class="row">
                                <div class="form-inline"> 
                                    <label style="margin-left: 10px">No sesi :</label>
                                <div class="col-sm-3">
                                    <select name="sykast.sytNosesi" id="findSenaraiKewpa26ListLink2_sykast_sytNosesi" class="form-control input-sm" title="No. Sesi" onchange="this.form.submit()">
