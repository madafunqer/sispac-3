            ...
            <div class="card-body">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">Sesi Pelupusan (Lelong) &gt; Borang Lelong</h3>
                    </div>
                    <div class="panel-body" id="panel">
                        <form id="findSenaraiKewpa27aListLink2" name="findSenaraiKewpa27aListLink2" action="/ePBT_SSHT/pelupusan/findSenaraiKewpa27aListLink2" method="post" class="form-horizontal">
                            <div class="row">
                                <div class="form-inline"> 
                                    <label style="margin-left: 10px">No sesi :</label>
                                <div class="col-sm-3">
                                    <select name="sykast.sytNosesi" id="findSenaraiKewpa27aListLink2_sykast_sytNosesi" class="form-control input-sm" title="No. Sesi" onchange="this.form.submit()">
