        ...
        <div class="card-body">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">[KEW.PA 35]Senarai Laporan Akhir Kehilangan</h3>
                </div>
                <div class="panel-body" id="panel">
                    <form id="findDaftarAkhirHilangListLink2" name="findDaftarAkhirHilangListLink2" action="/ePBT_SSHT/hapuskira/findDaftarAkhirHilangListLink2" method="post" class="form-horizontal">
                        ...
                        <div class="row">                        
                            <div class="form-inline">
                                ...
                                <div class="col-sm">
                                    <select name="shapus.hapusTahun" id="findDaftarAkhirHilangListLink2_shapus_hapusTahun" class="form-control input-sm" title="Tahun" onchange="this.form.submit()">
