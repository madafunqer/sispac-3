            ...
            <div class="card-body">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">Sesi Pelupusan (Tender) &gt; [KEW.PA 24] Kenyataan Tawaran Tender </h3>
                    </div>
                    <div class="panel-body" id="panel">
                        <form id="findSenaraiKewpa242018ListLink2" name="findSenaraiKewpa242018ListLink2" action="/ePBT_SSHT/pelupusan/findSenaraiKewpa242018ListLink2" method="post" class="form-horizontal">
                            <div class="row">
                                <div class="form-inline"> 
                                    <label style="margin-left: 10px">No sesi :</label>
                                <div class="col-sm-3">
                                    <select name="sesast.ssaNosesi" id="findSenaraiKewpa242018ListLink2_sesast_ssaNosesi" class="form-control input-sm" title="No. Sesi" onchange="this.form.submit()">
