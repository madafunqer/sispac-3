            ...
            <div class="card-body">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">Sesi Pelupusan &gt; [KEW.PA 20] Lantikan Lembaga</h3>
                    </div>
                    <div class="panel-body" id="panel">
                        <form id="findDaftarLemPemeriksaListLink2" name="findDaftarLemPemeriksaListLink2" action="/ePBT_SSHT/pelupusan/findDaftarLemPemeriksaListLink2" method="post" class="form-horizontal">
                            <div class="row">
                                <div class="form-inline"> 
                                    <label style="margin-left: 10px">No sesi :</label>
                                <div class="col-sm-3">
                                    <select name="sespeg.sepNosesi" id="findDaftarLemPemeriksaListLink2_sespeg_sepNosesi" class="form-control input-sm" title="No. Sesi" onchange="this.form.submit()">
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-condensed table-responsive table-striped dataTable no-footer" id="models" role="grid" aria-describedby="models_info" cellpadding="5px;">
                                    <thead class="thead-dark">
                                        <tr role="row">
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 40%">Nama Pegawai</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%">No. Rujukan</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%">Tarikh Mula</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%">Tarikh Tamat</th>
