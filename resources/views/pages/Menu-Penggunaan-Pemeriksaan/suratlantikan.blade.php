        ...
        <div class="card-body">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Surat Lantikan Pegawai Pemeriksa</h3>
                </div>
                <div class="panel-body" id="panel">
                    <form id="findDaftarPegPemeriksaListLink2" name="findDaftarPegPemeriksaListLink2" action="/ePBT_SSHT/penggunaan/findDaftarPegPemeriksaListLink2" method="post" class="form-horizontal">

                        <div class="row">
                            <div class="form-inline"> 
                                <label style="margin-left: 10px">No sesi :</label>
                            <div class="col-sm-3">
                                <select name="sespeg.sepNosesi" id="findDaftarPegPemeriksaListLink2_sespeg_sepNosesi" class="form-control input-sm" title="No. Sesi" onchange="this.form.submit()">
