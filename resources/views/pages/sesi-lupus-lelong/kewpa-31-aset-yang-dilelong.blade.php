            ...
            <div class="card-body">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">Sesi Pelupusan (Lelong) &gt; [KEW.PA 31] Aset Yang Dilelong</h3>
                    </div>
                    <div class="panel-body" id="panel">
                        <form id="findSenaraiKewpa27ListLink2" name="findSenaraiKewpa27ListLink2" action="/ePBT_SSHT/pelupusan/findSenaraiKewpa27ListLink2" method="post" class="form-horizontal">
                            <div class="row">
                                <div class="form-inline"> 
                                    <label style="margin-left: 10px">No sesi :</label>
                                <div class="col-sm-3">
                                    <select name="sesast.ssaNosesi" id="findSenaraiKewpa27ListLink2_sesast_ssaNosesi" class="form-control input-sm" title="No. Sesi" onchange="this.form.submit()">
                                ...
                                <table class="table table-bordered table-condensed table-responsive table-striped dataTable no-footer" id="models" role="grid" aria-describedby="models_info" cellpadding="5px;">
                                    <thead class="thead-dark">
                                        <tr role="row">
                                            ...
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 30%">Jumlah Kos [RM]</th>
