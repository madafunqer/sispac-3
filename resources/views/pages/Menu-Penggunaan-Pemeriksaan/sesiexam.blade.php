    ...
    <div class="card">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h3 class="panel-title">Sesi Pemeriksaan</h3>
            </div>
            <div class="panel-body" id="panel">
                <form id="findSesiPemeriksaanListLink2" name="findSesiPemeriksaanListLink2" action="/ePBT_SSHT/penggunaan/findSesiPemeriksaanListLink2" method="post" class="form-horizontal">

                    <div class="row">
                        <div class="form-inline"> 
                            <label style="margin-left: 10px">Tahun :</label>
                            <div class="col-sm-2">
                            <select name="sessil.sesTahuns" id="findSesiPemeriksaanListLink2_sessil_sesTahuns" class="form-control input-sm" title="Tahun" onchange="this.form.submit()">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered table-condensed table-responsive table-striped dataTable no-footer" id="models" role="grid" aria-describedby="models_info" cellpadding="5px;">
                            ...
                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 30%">Tarikh Pemeriksaan</th>
