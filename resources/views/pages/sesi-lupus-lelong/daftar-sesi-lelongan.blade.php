...
@section('content')
            ...
            <div class="card-body">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">Sesi Pelupusan (Lelong) &gt; Daftar Sesi Lelongan</h3>
                    </div>
                    <div class="panel-body" id="panel">
                        <form id="findSesiLelongListLink2" name="findSesiLelongListLink2" action="/ePBT_SSHT/pelupusan/findSesiLelongListLink2" method="post" class="form-horizontal">
                            <div class="row">
                                <div class="form-inline"> 
                                    <label style="margin-left: 10px">Tahun :</label>
                                <div class="col-sm-2">
                                    <select name="sessil.sesTahuns" id="findSesiLelongListLink2_sessil_sesTahuns" class="form-control input-sm" title="Tahun" onchange="this.form.submit()">
    ...
    <div class="content">
        ...
        <div class="table-responsive">
                    ...
                    <div class="mb">
                        <a href="javascript:void(0);" onclick="href='inputSesiLelongLink2?sessil.sesTahuns='">
                            <button class="daftar btn btn-primary" id="btnAdd"><i class="fa fa-plus-circle"></i>&nbsp;Rekod Baru</button>
                        </a>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="dataTables_length" id="models_length">
                                    <label>Paparkan <select name="models_length" aria-controls="models" class="form-control input-sm"><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option><option value="-1">Semua</option></select></label>rekod
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-condensed table-responsive table-striped dataTable no-footer" id="models" role="grid" aria-describedby="models_info" cellpadding="5px;">
                                    <thead class="thead-dark">
                                        <tr role="row">
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%">Kod Sesi</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 70%">Keterangan</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%">Tarikh Lelong</th>
