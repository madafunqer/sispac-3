        ...
        <div class="card-body">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">[KEW.PA 33]Senarai Kehilangan Aset </h3>
                </div>
                <div class="panel-body" id="panel">
                    <form id="findSenaraiKewpa28ListLink2" name="findSenaraiKewpa28ListLink2" action="/ePBT_SSHT/hapuskira/findSenaraiKewpa28ListLink2" method="post" class="form-horizontal">

                        <div class="row">                        
                            <div class="form-inline">
                                <label class="col-sm control-label" style="margin-right: -20px">Tahun :</label>
                                <div class="col-sm">
                                    <select name="shapus.hapusTahun" id="findSenaraiKewpa28ListLink2_shapus_hapusTahun" class="form-control input-sm" title="Tahun" onchange="this.form.submit()">
