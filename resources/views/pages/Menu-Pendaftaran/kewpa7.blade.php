            ...
            <div class="panel panel-default">
                <div id="infoMessage" style="display: none;"></div>
                    ...
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">[KEW.PA 7] Senarai Aset Alih</h3>
                    </div>
                
                    <div class="panel-body" id="panel">
                        <form id="findSenaraiKewpa07ListLink2" name="findSenaraiKewpa07ListLink2" action="/ePBT_SSHT/pendaftaran/findSenaraiKewpa07ListLink2" method="post" class="form-horizontal">
                            <br>
                            <div class="row">

                                    <label class="col-sm-2" style="margin-right: -80px">Jabatan :</label>
                                    <div class="col-sm">
                                        <select name="ssllks2.sllksLokkd" id="findSenaraiKewpa07ListLink2_ssllks2_sllksLokkd" class="form-control input-sm" title="Lokasi" onchange="this.form.submit()">
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-condensed table-responsive table-striped dataTable no-footer" id="models" role="grid" aria-describedby="models_info" cellpadding="5px;">
                                    <thead class="thead-dark">
                                        <tr role="row">
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 70%">Nama Jabatan</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 40%">Kauntiti</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 30%">Tindakan</th>
                                        </tr>
                                    </thead>
                                    <tbody> 
