            ...
            <div class="card-body">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">Sesi Pelupusan (Tender) &gt; [KEW.PA 26] Jadual Tender </h3>
                    </div>
                    <div class="panel-body" id="panel">
                        <form id="findSenaraiKewpa23ListLink2" name="findSenaraiKewpa23ListLink2" action="/ePBT_SSHT/pelupusan/findSenaraiKewpa23ListLink2" method="post" class="form-horizontal">
                            <div class="row">
                                <div class="form-inline"> 
                                    <label style="margin-left: 10px">No sesi :</label>
                                <div class="col-sm-4">
                                    <select name="sykast.sytNosesi" id="findSenaraiKewpa23ListLink2_sykast_sytNosesi" class="form-control input-sm" title="No. Sesi" onchange="this.form.submit()">
                                        <option value=""> Pilih No. Sesi </option>
                                        <option value="T/002/2020">T/002/2020</option>
                                        <option value="T/001/2020">T/001/2020</option>
                                    </select>
                                </div>
                            </div>    
                            <div class="form-inline"> 
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-condensed table-responsive table-striped dataTable no-footer" id="models" role="grid" aria-describedby="models_info" cellpadding="5px;">
                                    <thead class="thead-dark">
                                        <tr role="row">
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 10%">No. Syarikat</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 50%">Nama Syarikat</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%">Harga Tawaran Tender [RM]</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 20%">Status Tawaran Tender </th>
